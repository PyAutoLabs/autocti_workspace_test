...
array_1d_plotter = aplt.Array1DPlotter(
    ...
    mat_plot_1d=aplt.MatPlot1D(
        ...
        ylabel=aplt.YLabel(label="electrons"),
    ),
)
...
"""
We can now add CTI to our 1D data by passing it through the 1D clocker_1d.
...
"""
data_corrected_1d = clocker_1d.remove_cti(data=post_cti_data_1d, cti=cti)
