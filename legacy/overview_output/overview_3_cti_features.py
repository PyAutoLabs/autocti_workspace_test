...
array_1d_plotter = aplt.Array1DPlotter(
    ...
    mat_plot_1d=aplt.MatPlot1D(
        ...
        output=aplt.Output(path=workspace_path, filename="density_1", format="png"),
    ),
)
...
array_1d_plotter = aplt.Array1DPlotter(
    ...
    mat_plot_1d=aplt.MatPlot1D(
        ...
        output=aplt.Output(path=workspace_path, filename="density_2", format="png"),
    ),
)
array_1d_plotter.figure_1d()
...
array_1d_plotter = aplt.Array1DPlotter(
    ...
    mat_plot_1d=aplt.MatPlot1D(
        ...
        output=aplt.Output(path=workspace_path, filename="timescale_1", format="png"),
    ),
)
array_1d_plotter.figure_1d()
...
array_1d_plotter = aplt.Array1DPlotter(
    ...
    mat_plot_1d=aplt.MatPlot1D(
        ...
        output=aplt.Output(path=workspace_path, filename="timescale_2", format="png"),
    ),
)
array_1d_plotter.figure_1d()
...
array_1d_plotter = aplt.Array1DPlotter(
    ...
    mat_plot_1d=aplt.MatPlot1D(
        ...
        output=aplt.Output(path=workspace_path, filename="volume_1", format="png"),
    ),
)
array_1d_plotter.figure_1d()
...
array_1d_plotter = aplt.Array1DPlotter(
    ...
    mat_plot_1d=aplt.MatPlot1D(
        ...
        output=aplt.Output(path=workspace_path, filename="volume_2", format="png"),
    ),
)
array_1d_plotter.figure_1d()
