...
imaging_ci_plotter = aplt.ImagingCIPlotter(
    ...
    mat_plot_2d=aplt.MatPlot2D(
        ...
        output=aplt.Output(path=workspace_path, filename="imaging_ci", format="png"),
    ),
)
...
mat_plot_2d = aplt.MatPlot2D(
    ...
    output=aplt.Output(path=workspace_path, filename="imaging_ci_fpr", format="png"),
)

imaging_ci_plotter = aplt.ImagingCIPlotter(dataset=imaging_ci, mat_plot_2d=mat_plot_2d)
imaging_ci_plotter.figures_2d(image=True)
...
mat_plot_2d = aplt.MatPlot2D(
    ...
    output=aplt.Output(path=workspace_path, filename="imaging_ci_eper", format="png"),
)
...
"""
parallel_eper_1d = layout_2d.extract.parallel_eper.binned_array_1d_from(
...
array_1d_plotter = aplt.Array1DPlotter(
    ...
    mat_plot_1d=aplt.MatPlot1D(
        ...
        output=aplt.Output(
            path=workspace_path, filename="binned_parallel_eper", format="png"
        ),
    ),
)
...
"""
parallel_fpr_1d = layout_2d.extract.parallel_fpr.binned_array_1d_from(
    array=imaging_ci.image, pixels=(0, 10)
)
array_1d_plotter = aplt.Array1DPlotter(
    y=parallel_fpr_1d,
    mat_plot_1d=aplt.MatPlot1D(
        ...
        output=aplt.Output(
            path=workspace_path, filename="binned_parallel_fpr", format="png"
        ),
    ),
)
array_1d_plotter.figure_1d()

serial_eper_1d = layout_2d.extract.serial_eper.binned_array_1d_from(
    array=imaging_ci.image, pixels=(0, 10)
)
array_1d_plotter = aplt.Array1DPlotter(
    y=serial_eper_1d,
    mat_plot_1d=aplt.MatPlot1D(
        ...
        output=aplt.Output(
            path=workspace_path, filename="binned_serial_eper", format="png"
        ),
    ),
)
array_1d_plotter.figure_1d()

serial_fpr_1d = layout_2d.extract.serial_fpr.binned_array_1d_from(
    array=imaging_ci.image, pixels=(0, 10)
)
array_1d_plotter = aplt.Array1DPlotter(
    y=serial_fpr_1d,
    mat_plot_1d=aplt.MatPlot1D(
        ...
        output=aplt.Output(
            path=workspace_path, filename="binned_serial_fpr", format="png"
        ),
    ),
)
array_1d_plotter.figure_1d()
...
imaging_ci_plotter = aplt.ImagingCIPlotter(
    ...
    mat_plot_2d=aplt.MatPlot2D(
        ...
        output=aplt.Output(path=workspace_path, filename="pre_cti_image", format="png"),
    ),
)
...
imaging_ci_plotter = aplt.ImagingCIPlotter(
    ...
    mat_plot_2d=aplt.MatPlot2D(
        ...
        output=aplt.Output(
            path=workspace_path,
            filename="imaging_ci_non_uniform_cosmic_rays",
            format="png",
        ),
    ),
)
